...
for (const [g, cmd] of [
  ...
  ['Live invite/claim contract (B7)', 'GitHub workflow — Verify Authenticated Worker (runs scripts/verify-live-invite-claim.mjs after every dispatched Worker deploy); UNOBSERVED is not a pass'],
