...
**Observed production 2026-09-21: v24.0.28 / DB16 / Worker v21.**
PR #294 merged runtime v24.0.28 as `764ea091e2ae3157a9c9d7a532ab802147388220`;
its exact PR head passed Tests `35657810077` (job `106525656602`) at **746/0 across 72 specs**.
Current settled observation checkpoint `675e6fb0140f0e226219fc52955932703fc07a1c`
passed Tests `35661894446` (job `106538812253`) at **746/0**, CodeQL
`35661894363`, Live Parity `35661894518` (job `106538813802`), and Production
Service Worker `35661894391` (job `106538814618`). The live gates directly observe
app/SW/manifest **24.0.28**, Worker **v21**, all **22** declared runtime assets,
**20** repository-only paths withheld, `freightlogic-24.0.28` with all 22 assets in
precache, five tabs + Today after reload, no uncaught page errors, and exactly one
app-generation cache. Source and observed production therefore agree at v24.0.28.
...
- Settled current observation checkpoint: `675e6fb0140f0e226219fc52955932703fc07a1c`.
- Exact-main Tests `35661894446`, job `106538812253`: **746/0 across 72 specs**;
  CodeQL `35661894363`: **PASS**.
- Live Parity `35661894518`, job `106538813802`: **PASS** — app/SW/manifest 24.0.28,
  Worker v21, 22/22 runtime assets, 20 repository-only paths withheld.
- Production Service Worker `35661894391`, job `106538814618`: **PASS** —
  activated/controlled worker, `freightlogic-24.0.28` with all 22 assets, five tabs +
  visible Today after reload, no uncaught page errors, exactly one generation cache.
