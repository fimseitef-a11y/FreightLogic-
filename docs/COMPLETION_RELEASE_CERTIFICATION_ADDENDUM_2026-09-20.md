...
> Historical draft record preserved from Claude PR #282. Superseded by
> `COMPLETION_RELEASE_CERTIFICATION_STATE_2026-09-21.md`.
> The original status below overstates the scope of live evidence: the authenticated
> `/extract-image` provider invocation had not run. The 2026-09-21 state corrects that
> claim without discarding these v24.0.25 parity/service-worker observations.
