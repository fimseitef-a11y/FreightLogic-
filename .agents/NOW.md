...
| gpt | — idle — (A13 runner implementation is PR #254 @ b3eaa9b; Lanes/CodeQL green, full Tests still running at checkpoint. Reclaim only if CI reports a real failure.) | 2026-09-18 |
