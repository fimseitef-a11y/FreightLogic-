...
| gpt | Admin Console Cloudflare separate-origin deployment seam in GPT-owned `admin-console/`; adding static-assets Worker wrapper/config/security headers, no driver/runtime/backend/workflow paths touched. | 2026-09-19 |
