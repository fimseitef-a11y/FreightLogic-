...
PR #294 merged the runtime as `764ea091e2ae3157a9c9d7a532ab802147388220`; its exact PR head
passed Tests `35657810077` (job `106525656602`) at **746/0 across 72 specs**.
On later exact-main checkpoint `675e6fb0140f0e226219fc52955932703fc07a1c`,
Tests `35661894446` (job `106538812253`) again passed **746/0 across 72 specs**;
Live Parity `35661894518` (job `106538813802`) and Production Service Worker
`35661894391` (job `106538814618`) both returned `VERDICT: PASS`, directly
observing app/SW/manifest **24.0.28**, Worker **v21**, all **22** runtime assets,
`freightlogic-24.0.28`, five tabs + Today after reload, no uncaught page errors,
and exactly one app-generation cache. CodeQL `35661894363` also passed.
