...
# BANK-10: preserve a legitimate leading minus in a bank Amount field without
# weakening sanitizeImportValue(), which remains the generic formula guard.
...
# BANK-11: transfer/card-payment candidates may be written only after the user
# explicitly reclassifies them away from the non-deductible review bucket.
