/* FreightLogic v24.0.0 — Browser Hardened Service Worker */
...
const ADMIN_UI_TAG = '<script src="admin-driver-ui.js?v=24.0.0"></script>';
const MIDWEST_STACK_TAG = '<script src="midwest-stack-authority.js?v=24.0.0"></script>';
const CORE = [
  './', APP_SHELL,
  './app.js?v=24.0.0',
