/* FreightLogic v24.0.44 — Browser Hardened Service Worker */
const SW_VERSION = '24.0.44';
...
const MIDWEST_STACK_TAG = '<script src="midwest-stack-authority.js?v=24.0.44"></script>';
const CORE = [
  './', APP_SHELL,
  './app.js?v=24.0.44',
  './styles.css',
  './midwest-stack-authority.js?v=24.0.44',
  './manifest.json?v=24.0.44',
  ...
  './sw-bridge.js?v=24.0.44',
  './modern-shell.js?v=24.0.44'
];
...
function normalizeAssetPath(pathname) {
  // './app.js?v=24.0.44' and '/app.js' must resolve to the same identity.
...
self.addEventListener('install', (event) => {
  event.waitUntil((async () => {
    ...
    const critical = ['./', APP_SHELL, './app.js?v=24.0.44', './styles.css', './sw-bridge.js?v=24.0.44', './modern-shell.js?v=24.0.44', './manifest.json?v=24.0.44', './midwest-stack-authority.js?v=24.0.44', './vendor/xlsx.full.min.js'];
