/* FreightLogic v24.0.31 — Browser Hardened Service Worker */
const SW_VERSION = '24.0.31';
...
const ADMIN_UI_TAG = '<script src="admin-driver-ui.js?v=24.0.31"></script>';
const MIDWEST_STACK_TAG = '<script src="midwest-stack-authority.js?v=24.0.31"></script>';
const CORE = [
  './', APP_SHELL,
  './app.js?v=24.0.31',
  './styles.css',
  './admin-driver-ui.js?v=24.0.31',
  './midwest-stack-authority.js?v=24.0.31',
  './manifest.json?v=24.0.31',
  ...
  './sw-bridge.js?v=24.0.31',
  './modern-shell.js?v=24.0.31'
];
...
function normalizeAssetPath(pathname) {
  // './app.js?v=24.0.31' and '/app.js' must resolve to the same identity.
...
self.addEventListener('install', (event) => {
  event.waitUntil((async () => {
    ...
    const critical = ['./', APP_SHELL, './app.js?v=24.0.31', './styles.css', './sw-bridge.js?v=24.0.31', './modern-shell.js?v=24.0.31', './manifest.json?v=24.0.31', './midwest-stack-authority.js?v=24.0.31', './vendor/xlsx.full.min.js'];
