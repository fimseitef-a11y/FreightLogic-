/* FreightLogic v24.0.23 — Browser Hardened Service Worker */
const SW_VERSION = '24.0.23';
...
const ADMIN_UI_TAG = '<script src="admin-driver-ui.js?v=24.0.23"></script>';
const MIDWEST_STACK_TAG = '<script src="midwest-stack-authority.js?v=24.0.23"></script>';
const CORE = [
  './', APP_SHELL,
  './app.js?v=24.0.23',
  './styles.css',
  './admin-driver-ui.js?v=24.0.23',
  './midwest-stack-authority.js?v=24.0.23',
  './manifest.json?v=24.0.23',
  ...
  './sw-bridge.js?v=24.0.23',
  './modern-shell.js?v=24.0.23'
];
...
function normalizeAssetPath(pathname) {
  // './app.js?v=24.0.23' and '/app.js' must resolve to the same identity.
...
self.addEventListener('install', (event) => {
  event.waitUntil((async () => {
    ...
    const critical = ['./', APP_SHELL, './app.js?v=24.0.23', './styles.css', './sw-bridge.js?v=24.0.23', './modern-shell.js?v=24.0.23', './manifest.json?v=24.0.23', './midwest-stack-authority.js?v=24.0.23', './vendor/xlsx.full.min.js'];
