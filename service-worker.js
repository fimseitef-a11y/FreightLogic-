/* FreightLogic v24.0.8 — Browser Hardened Service Worker */
const SW_VERSION = '24.0.8';
...
const ADMIN_UI_TAG = '<script src="admin-driver-ui.js?v=24.0.8"></script>';
const MIDWEST_STACK_TAG = '<script src="midwest-stack-authority.js?v=24.0.8"></script>';
const CORE = [
  './', APP_SHELL,
  './app.js?v=24.0.8',
  './voice-load.js?v=24.0.8',
  './styles.css',
  './admin-driver-ui.js?v=24.0.8',
  './midwest-stack-authority.js?v=24.0.8',
  './manifest.json?v=24.0.8',
...
function normalizeAssetPath(pathname) {
  // './app.js?v=24.0.8' and '/app.js' must resolve to the same identity.
...
self.addEventListener('install', (event) => {
  event.waitUntil((async () => {
    ...
    const critical = ['./', APP_SHELL, './app.js?v=24.0.8', './voice-load.js?v=24.0.8', './styles.css', './sw-bridge.js?v=24.0.8', './modern-shell.js?v=24.0.8', './manifest.json?v=24.0.8', './midwest-stack-authority.js?v=24.0.8', './vendor/xlsx.full.min.js'];
