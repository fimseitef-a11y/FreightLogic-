/* FreightLogic v24.0.1 — Browser Hardened Service Worker */
const SW_VERSION = '24.0.1';
...
const ADMIN_UI_TAG = '<script src="admin-driver-ui.js?v=24.0.1"></script>';
const MIDWEST_STACK_TAG = '<script src="midwest-stack-authority.js?v=24.0.1"></script>';
const CORE = [
  './', APP_SHELL,
  './app.js?v=24.0.1',
  './voice-load.js?v=24.0.1',
  './styles.css',
  './admin-driver-ui.js?v=24.0.1',
  './midwest-stack-authority.js?v=24.0.1',
  './manifest.json?v=24.0.1',
...
self.addEventListener('install', (event) => {
  event.waitUntil((async () => {
    ...
    const critical = ['./', APP_SHELL, './app.js?v=24.0.1', './voice-load.js?v=24.0.1', './styles.css', './sw-bridge.js?v=24.0.1', './manifest.json?v=24.0.1', './midwest-stack-authority.js?v=24.0.1', './vendor/xlsx.full.min.js'];
