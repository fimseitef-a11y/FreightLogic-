/* FreightLogic v23.4.0 — Browser Hardened Service Worker */
const SW_VERSION = '23.4.0';
...
const ADMIN_UI_TAG = '<script src="admin-driver-ui.js?v=23.4.0"></script>';
const CORE = [
  './', APP_SHELL,
  './app.js?v=23.4.0',
  './voice-load.js?v=23.4.0',
  './admin-driver-ui.js?v=23.4.0',
  './manifest.json?v=23.4.0',
