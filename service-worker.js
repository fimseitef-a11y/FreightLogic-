/* FreightLogic v24.0.19 — Browser Hardened Service Worker */
const SW_VERSION = '24.0.19';
...
const ADMIN_UI_TAG = '<script src="admin-driver-ui.js?v=24.0.19"></script>';
const MIDWEST_STACK_TAG = '<script src="midwest-stack-authority.js?v=24.0.19"></script>';
const CORE = [
  './', APP_SHELL,
  './app.js?v=24.0.19',
  './styles.css',
  './admin-driver-ui.js?v=24.0.19',
  './midwest-stack-authority.js?v=24.0.19',
  './manifest.json?v=24.0.19',
  ...
  './sw-bridge.js?v=24.0.19',
  './modern-shell.js?v=24.0.19'
];
...
function normalizeAssetPath(pathname) {
  // './app.js?v=24.0.19' and '/app.js' must resolve to the same identity.
...
self.addEventListener('install', (event) => {
  event.waitUntil((async () => {
    ...
    const critical = ['./', APP_SHELL, './app.js?v=24.0.19', './styles.css', './sw-bridge.js?v=24.0.19', './modern-shell.js?v=24.0.19', './manifest.json?v=24.0.19', './midwest-stack-authority.js?v=24.0.19', './vendor/xlsx.full.min.js'];
