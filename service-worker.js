/* FreightLogic v24.0.45 — Browser Hardened Service Worker */
const SW_VERSION = '24.0.45';
...
const MIDWEST_STACK_TAG = '<script src="midwest-stack-authority.js?v=24.0.45"></script>';
const CORE = [
  './', APP_SHELL,
  './app.js?v=24.0.45',
  './styles.css',
  './midwest-stack-authority.js?v=24.0.45',
  './manifest.json?v=24.0.45',
  ...
  './sw-bridge.js?v=24.0.45',
  './modern-shell.js?v=24.0.45'
];
...
function normalizeAssetPath(pathname) {
  // './app.js?v=24.0.45' and '/app.js' must resolve to the same identity.
...
self.addEventListener('install', (event) => {
  event.waitUntil((async () => {
    ...
    const critical = ['./', APP_SHELL, './app.js?v=24.0.45', './styles.css', './sw-bridge.js?v=24.0.45', './modern-shell.js?v=24.0.45', './manifest.json?v=24.0.45', './midwest-stack-authority.js?v=24.0.45', './vendor/xlsx.full.min.js'];
