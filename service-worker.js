/* FreightLogic v24.0.21 — Browser Hardened Service Worker */
const SW_VERSION = '24.0.21';
...
const ADMIN_UI_TAG = '<script src="admin-driver-ui.js?v=24.0.21"></script>';
const MIDWEST_STACK_TAG = '<script src="midwest-stack-authority.js?v=24.0.21"></script>';
const CORE = [
  './', APP_SHELL,
  './app.js?v=24.0.21',
  './styles.css',
  './admin-driver-ui.js?v=24.0.21',
  './midwest-stack-authority.js?v=24.0.21',
  './manifest.json?v=24.0.21',
  ...
  './sw-bridge.js?v=24.0.21',
  './modern-shell.js?v=24.0.21'
];
...
function normalizeAssetPath(pathname) {
  // './app.js?v=24.0.21' and '/app.js' must resolve to the same identity.
...
self.addEventListener('install', (event) => {
  event.waitUntil((async () => {
    ...
    const critical = ['./', APP_SHELL, './app.js?v=24.0.21', './styles.css', './sw-bridge.js?v=24.0.21', './modern-shell.js?v=24.0.21', './manifest.json?v=24.0.21', './midwest-stack-authority.js?v=24.0.21', './vendor/xlsx.full.min.js'];
