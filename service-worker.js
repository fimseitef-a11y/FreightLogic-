/* FreightLogic v24.0.15 — Browser Hardened Service Worker */
const SW_VERSION = '24.0.15';
...
const ADMIN_UI_TAG = '<script src="admin-driver-ui.js?v=24.0.15"></script>';
const MIDWEST_STACK_TAG = '<script src="midwest-stack-authority.js?v=24.0.15"></script>';
const CORE = [
  './', APP_SHELL,
  './app.js?v=24.0.15',
  './voice-load.js?v=24.0.15',
  './styles.css',
  './admin-driver-ui.js?v=24.0.15',
  './midwest-stack-authority.js?v=24.0.15',
  './manifest.json?v=24.0.15',
  ...
  './sw-bridge.js?v=24.0.15',
  './modern-shell.js?v=24.0.15'
];
...
function normalizeAssetPath(pathname) {
  // './app.js?v=24.0.15' and '/app.js' must resolve to the same identity.
...
self.addEventListener('install', (event) => {
  event.waitUntil((async () => {
    ...
    const critical = ['./', APP_SHELL, './app.js?v=24.0.15', './voice-load.js?v=24.0.15', './styles.css', './sw-bridge.js?v=24.0.15', './modern-shell.js?v=24.0.15', './manifest.json?v=24.0.15', './midwest-stack-authority.js?v=24.0.15', './vendor/xlsx.full.min.js'];
