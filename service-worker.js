/* FreightLogic v23.3.1 — Browser Hardened Service Worker */
const SW_VERSION = '23.3.1';
...
const ADMIN_UI_TAG = '<script src="admin-driver-ui.js?v=23.3.1"></script>';
const CORE = [
  './', APP_SHELL,
  './app.js?v=23.3.1',
  './voice-load.js?v=23.3.1',
  './admin-driver-ui.js?v=23.3.1',
  './manifest.json?v=23.3.1',
