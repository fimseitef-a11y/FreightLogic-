/* FreightLogic v24.0.37 — Browser Hardened Service Worker */
const SW_VERSION = '24.0.37';
...
const MIDWEST_STACK_TAG = '<script src="midwest-stack-authority.js?v=24.0.37"></script>';
const CORE = [
  './', APP_SHELL,
  './app.js?v=24.0.37',
  './styles.css',
  './midwest-stack-authority.js?v=24.0.37',
  './manifest.json?v=24.0.37',
  ...
  './sw-bridge.js?v=24.0.37',
  './modern-shell.js?v=24.0.37'
];
...
function normalizeAssetPath(pathname) {
  // './app.js?v=24.0.37' and '/app.js' must resolve to the same identity.
...
self.addEventListener('install', (event) => {
  event.waitUntil((async () => {
    ...
    const critical = ['./', APP_SHELL, './app.js?v=24.0.37', './styles.css', './sw-bridge.js?v=24.0.37', './modern-shell.js?v=24.0.37', './manifest.json?v=24.0.37', './midwest-stack-authority.js?v=24.0.37', './vendor/xlsx.full.min.js'];
