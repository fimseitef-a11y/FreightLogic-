/* FreightLogic v24.0.38 — Browser Hardened Service Worker */
const SW_VERSION = '24.0.38';
...
const MIDWEST_STACK_TAG = '<script src="midwest-stack-authority.js?v=24.0.38"></script>';
const CORE = [
  './', APP_SHELL,
  './app.js?v=24.0.38',
  './styles.css',
  './midwest-stack-authority.js?v=24.0.38',
  './manifest.json?v=24.0.38',
  ...
  './sw-bridge.js?v=24.0.38',
  './modern-shell.js?v=24.0.38'
];
...
function normalizeAssetPath(pathname) {
  // './app.js?v=24.0.38' and '/app.js' must resolve to the same identity.
...
self.addEventListener('install', (event) => {
  event.waitUntil((async () => {
    ...
    const critical = ['./', APP_SHELL, './app.js?v=24.0.38', './styles.css', './sw-bridge.js?v=24.0.38', './modern-shell.js?v=24.0.38', './manifest.json?v=24.0.38', './midwest-stack-authority.js?v=24.0.38', './vendor/xlsx.full.min.js'];
