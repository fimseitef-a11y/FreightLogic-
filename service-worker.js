/* FreightLogic v24.0.25 — Browser Hardened Service Worker */
const SW_VERSION = '24.0.25';
...
const ADMIN_UI_TAG = '<script src="admin-driver-ui.js?v=24.0.25"></script>';
const MIDWEST_STACK_TAG = '<script src="midwest-stack-authority.js?v=24.0.25"></script>';
const CORE = [
  './', APP_SHELL,
  './app.js?v=24.0.25',
  './styles.css',
  './admin-driver-ui.js?v=24.0.25',
  './midwest-stack-authority.js?v=24.0.25',
  './manifest.json?v=24.0.25',
  ...
  './sw-bridge.js?v=24.0.25',
  './modern-shell.js?v=24.0.25'
];
...
function normalizeAssetPath(pathname) {
  // './app.js?v=24.0.25' and '/app.js' must resolve to the same identity.
...
self.addEventListener('install', (event) => {
  event.waitUntil((async () => {
    ...
    const critical = ['./', APP_SHELL, './app.js?v=24.0.25', './styles.css', './sw-bridge.js?v=24.0.25', './modern-shell.js?v=24.0.25', './manifest.json?v=24.0.25', './midwest-stack-authority.js?v=24.0.25', './vendor/xlsx.full.min.js'];
