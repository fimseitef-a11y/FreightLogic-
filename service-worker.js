/* FreightLogic v24.0.18 — Browser Hardened Service Worker */
const SW_VERSION = '24.0.18';
...
const ADMIN_UI_TAG = '<script src="admin-driver-ui.js?v=24.0.18"></script>';
const MIDWEST_STACK_TAG = '<script src="midwest-stack-authority.js?v=24.0.18"></script>';
const CORE = [
  './', APP_SHELL,
  './app.js?v=24.0.18',
  './styles.css',
  './admin-driver-ui.js?v=24.0.18',
  './midwest-stack-authority.js?v=24.0.18',
  './manifest.json?v=24.0.18',
  ...
  './sw-bridge.js?v=24.0.18',
  './modern-shell.js?v=24.0.18'
];
...
function normalizeAssetPath(pathname) {
  // './app.js?v=24.0.18' and '/app.js' must resolve to the same identity.
...
self.addEventListener('install', (event) => {
  event.waitUntil((async () => {
    ...
    const critical = ['./', APP_SHELL, './app.js?v=24.0.18', './styles.css', './sw-bridge.js?v=24.0.18', './modern-shell.js?v=24.0.18', './manifest.json?v=24.0.18', './midwest-stack-authority.js?v=24.0.18', './vendor/xlsx.full.min.js'];
