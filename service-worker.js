/* FreightLogic v24.0.36 — Browser Hardened Service Worker */
const SW_VERSION = '24.0.36';
...
const MIDWEST_STACK_TAG = '<script src="midwest-stack-authority.js?v=24.0.36"></script>';
const CORE = [
  './', APP_SHELL,
  './app.js?v=24.0.36',
  './styles.css',
  './midwest-stack-authority.js?v=24.0.36',
  './manifest.json?v=24.0.36',
  ...
  './sw-bridge.js?v=24.0.36',
  './modern-shell.js?v=24.0.36'
];
...
function normalizeAssetPath(pathname) {
  // './app.js?v=24.0.36' and '/app.js' must resolve to the same identity.
...
self.addEventListener('install', (event) => {
  event.waitUntil((async () => {
    ...
    const critical = ['./', APP_SHELL, './app.js?v=24.0.36', './styles.css', './sw-bridge.js?v=24.0.36', './modern-shell.js?v=24.0.36', './manifest.json?v=24.0.36', './midwest-stack-authority.js?v=24.0.36', './vendor/xlsx.full.min.js'];
