/* FreightLogic v23.7.0 — Browser Hardened Service Worker */
const SW_VERSION = '23.7.0';
...
const ADMIN_UI_TAG = '<script src="admin-driver-ui.js?v=23.7.0"></script>';
const MIDWEST_STACK_TAG = '<script src="midwest-stack-authority.js?v=23.7.0"></script>';
const CORE = [
  './', APP_SHELL,
  './app.js?v=23.7.0',
  './voice-load.js?v=23.7.0',
  './admin-driver-ui.js?v=23.7.0',
  './midwest-stack-authority.js?v=23.7.0',
  './manifest.json?v=23.7.0',
