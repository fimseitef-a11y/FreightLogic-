/* FreightLogic v24.0.2 — Browser Hardened Service Worker */
...
self.addEventListener('install', (event) => {
  event.waitUntil((async () => {
    ...
    const critical = ['./', APP_SHELL, './app.js?v=24.0.2', './voice-load.js?v=24.0.2', './styles.css', './sw-bridge.js?v=24.0.2', './manifest.json?v=24.0.2', './midwest-stack-authority.js?v=24.0.2', './vendor/xlsx.full.min.js'];
