/* FreightLogic v24.1.0 — Browser Hardened Service Worker */
const SW_VERSION = '24.1.0';
...
const ADMIN_UI_TAG = '<script src="admin-driver-ui.js?v=24.1.0"></script>';
const MIDWEST_STACK_TAG = '<script src="midwest-stack-authority.js?v=24.1.0"></script>';
const CORE = [
  './', APP_SHELL,
  './app.js?v=24.1.0',
  './voice-load.js?v=24.1.0',
  './admin-driver-ui.js?v=24.1.0',
  './midwest-stack-authority.js?v=24.1.0',
  './manifest.json?v=24.1.0',
...
self.addEventListener('install', (event) => {
  event.waitUntil((async () => {
    ...
    const critical = ['./', APP_SHELL, './app.js?v=24.1.0', './voice-load.js?v=24.1.0', './sw-bridge.js?v=24.1.0', './manifest.json?v=24.1.0', './midwest-stack-authority.js?v=24.1.0', './vendor/xlsx.full.min.js'];
