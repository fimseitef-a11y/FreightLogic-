/* FreightLogic v24.0.22 — Browser Hardened Service Worker */
const SW_VERSION = '24.0.22';
...
const ADMIN_UI_TAG = '<script src="admin-driver-ui.js?v=24.0.22"></script>';
const MIDWEST_STACK_TAG = '<script src="midwest-stack-authority.js?v=24.0.22"></script>';
const CORE = [
  './', APP_SHELL,
  './app.js?v=24.0.22',
  './styles.css',
  './admin-driver-ui.js?v=24.0.22',
  './midwest-stack-authority.js?v=24.0.22',
  './manifest.json?v=24.0.22',
  ...
  './sw-bridge.js?v=24.0.22',
  './modern-shell.js?v=24.0.22'
];
...
function normalizeAssetPath(pathname) {
  // './app.js?v=24.0.22' and '/app.js' must resolve to the same identity.
...
self.addEventListener('install', (event) => {
  event.waitUntil((async () => {
    ...
    const critical = ['./', APP_SHELL, './app.js?v=24.0.22', './styles.css', './sw-bridge.js?v=24.0.22', './modern-shell.js?v=24.0.22', './manifest.json?v=24.0.22', './midwest-stack-authority.js?v=24.0.22', './vendor/xlsx.full.min.js'];
