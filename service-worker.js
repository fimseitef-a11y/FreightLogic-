/* FreightLogic v24.0.39 — Browser Hardened Service Worker */
const SW_VERSION = '24.0.39';
...
const MIDWEST_STACK_TAG = '<script src="midwest-stack-authority.js?v=24.0.39"></script>';
const CORE = [
  './', APP_SHELL,
  './app.js?v=24.0.39',
  './styles.css',
  './midwest-stack-authority.js?v=24.0.39',
  './manifest.json?v=24.0.39',
  ...
  './sw-bridge.js?v=24.0.39',
  './modern-shell.js?v=24.0.39'
];
...
function normalizeAssetPath(pathname) {
  // './app.js?v=24.0.39' and '/app.js' must resolve to the same identity.
...
self.addEventListener('install', (event) => {
  event.waitUntil((async () => {
    ...
    const critical = ['./', APP_SHELL, './app.js?v=24.0.39', './styles.css', './sw-bridge.js?v=24.0.39', './modern-shell.js?v=24.0.39', './manifest.json?v=24.0.39', './midwest-stack-authority.js?v=24.0.39', './vendor/xlsx.full.min.js'];
