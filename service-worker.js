/* FreightLogic v24.0.7 — Browser Hardened Service Worker */
const SW_VERSION = '24.0.7';
...
const ADMIN_UI_TAG = '<script src="admin-driver-ui.js?v=24.0.7"></script>';
const MIDWEST_STACK_TAG = '<script src="midwest-stack-authority.js?v=24.0.7"></script>';
const CORE = [
  './', APP_SHELL,
  './app.js?v=24.0.7',
  './voice-load.js?v=24.0.7',
  './styles.css',
  './admin-driver-ui.js?v=24.0.7',
  './midwest-stack-authority.js?v=24.0.7',
  './manifest.json?v=24.0.7',
...
function normalizeAssetPath(pathname) {
  // './app.js?v=24.0.7' and '/app.js' must resolve to the same identity.
