...
self.addEventListener('install', (event) => {
  event.waitUntil((async () => {
    ...
    const critical = ['./', APP_SHELL, './app.js?v=24.0.1', './voice-load.js?v=24.0.1', './sw-bridge.js?v=24.0.1', './manifest.json?v=24.0.1', './midwest-stack-authority.js?v=24.0.1', './vendor/xlsx.full.min.js'];
