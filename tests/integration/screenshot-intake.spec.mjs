...
async function scoreLoad(page, { revenue, loaded, dead, origin, dest }) {
  ...
  return page.evaluate(() => {
    ...
    return {
      ...
      // Closed <details> intentionally hides its body from innerText. SSI-15 is
      // checking the canonical detailed DOM value without opening the UI, so use
      // textContent here; the separate detailsOpen assertion still proves it starts collapsed.
